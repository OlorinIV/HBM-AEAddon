...
import com.glodblock.github.hbmaeaddon.common.block.BlockHBMFluidExposerHyper;
...
public class BlockAndItems {
    ...
    public static final BlockHBMFluidExposerHyper HBM_EXPOSER_HYPER = new BlockHBMFluidExposerHyper();
    ...
    public static void init(RegistryHandler handler) {
        ...
        handler.block(HBM_EXPOSER_HYPER, TileHBMFluidExposerHyper.class, "hbm_fluid_exposer_hyper");
